public class LinhaEncomenda {
    ...
    public LinhaEncomenda(String referencia, String descricao, double preco, int quantidade, double imposto,
            double desconto) {
    ...
    public boolean equals(Object obj) {
        ...
        return le.getReferencia().equals(this.referencia) && le.getDescricao().equals(this.descricao)
    ...
    public String toString() {
        ...
        sb.append("\nPreço antes de impostos: ").append(this.preco);
